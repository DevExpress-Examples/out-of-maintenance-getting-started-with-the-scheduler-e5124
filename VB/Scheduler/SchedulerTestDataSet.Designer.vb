...
Namespace Scheduler
	...
	'''</summary>
	<Global.System.Serializable(), Global.System.ComponentModel.DesignerCategoryAttribute("code"), Global.System.ComponentModel.ToolboxItem(True), Global.System.Xml.Serialization.XmlSchemaProviderAttribute("GetTypedDataSetSchema"), Global.System.Xml.Serialization.XmlRootAttribute("SchedulerTestDataSet"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")> _
	Partial Public Class SchedulerTestDataSet
		...
		Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
			Dim ds As New SchedulerTestDataSet()
		...
		Partial Public Class AppointmentsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Function AddAppointmentsRow(ByVal Type As Integer, ByVal StartDate As System.DateTime, ByVal EndDate As System.DateTime, ByVal AllDay As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status As Integer, ByVal Label As Integer, ByVal ResourceID As Integer, ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal CustomField1 As String) As AppointmentsRow
				Dim rowAppointmentsRow As AppointmentsRow = (CType(Me.NewRow(), AppointmentsRow))
				Dim columnValuesArray() As Object = { Nothing, Type, StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, CustomField1}
		...
		Partial Public Class ResourcesRow
			...
			Public Property UniqueID() As Integer
				Get
					Return (CInt(Fix(Me(Me.tableResources.UniqueIDColumn))))
				End Get
				Set(ByVal value As Integer)
			...
			Public Property ResourceID() As Integer
				Get
					Return (CInt(Fix(Me(Me.tableResources.ResourceIDColumn))))
				End Get
				Set(ByVal value As Integer)
	...
	End Class
End Namespace
Namespace Scheduler.SchedulerTestDataSetTableAdapters
	...
	Partial Public Class AppointmentsTableAdapter
		...
		Private Sub InitConnection()
			...
			Me._connection.ConnectionString = My.Settings.Default.SchedulerTestConnectionString1
		End Sub
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT UniqueID, Type, StartDate, EndDate, AllDay, Subject, Location, Description" & ", Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, CustomFi" & "eld1 FROM dbo.Appointments"
		...
		Public Overridable Function Fill(ByVal dataTable As SchedulerTestDataSet.AppointmentsDataTable) As Integer
		...
		Public Overridable Function GetData() As SchedulerTestDataSet.AppointmentsDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New SchedulerTestDataSet.AppointmentsDataTable()
		...
		Public Overridable Function Update(ByVal dataTable As SchedulerTestDataSet.AppointmentsDataTable) As Integer
			Return Me.Adapter.Update(dataTable)
		End Function

		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
		Public Overridable Function Update(ByVal dataSet As SchedulerTestDataSet) As Integer
		...
		Public Overridable Function Delete(ByVal Original_UniqueID As Integer, ByVal Original_Type? As Integer, ByVal Original_StartDate? As Global.System.DateTime, ByVal Original_EndDate? As Global.System.DateTime, ByVal Original_AllDay? As Boolean, ByVal Original_Subject As String, ByVal Original_Location As String, ByVal Original_Status? As Integer, ByVal Original_Label? As Integer, ByVal Original_ResourceID? As Integer) As Integer
			...
			If (Original_Status.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(14).Value = (CInt(Fix(Original_Status.Value)))
			Else
			...
			If (Original_Label.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(16).Value = (CInt(Fix(Original_Label.Value)))
			Else
			...
			If (Original_ResourceID.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(18).Value = (CInt(Fix(Original_ResourceID.Value)))
			Else
		...
		Public Overridable Function Insert(ByVal Type? As Integer, ByVal StartDate? As Global.System.DateTime, ByVal EndDate? As Global.System.DateTime, ByVal AllDay? As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status? As Integer, ByVal Label? As Integer, ByVal ResourceID? As Integer, ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal CustomField1 As String) As Integer
			...
			Else
				Me.Adapter.InsertCommand.Parameters(13).Value = (CStr(CustomField1))
			End If
		...
		Public Overridable Function Update(ByVal Type? As Integer, ByVal StartDate? As Global.System.DateTime, ByVal EndDate? As Global.System.DateTime, ByVal AllDay? As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status? As Integer, ByVal Label? As Integer, ByVal ResourceID? As Integer, ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal CustomField1 As String, ByVal Original_UniqueID As Integer, ByVal Original_Type? As Integer, ByVal Original_StartDate? As Global.System.DateTime, ByVal Original_EndDate? As Global.System.DateTime, ByVal Original_AllDay? As Boolean, ByVal Original_Subject As String, ByVal Original_Location As String, ByVal Original_Status? As Integer, ByVal Original_Label? As Integer, ByVal Original_ResourceID? As Integer, ByVal UniqueID As Integer) As Integer
			If (Type.HasValue = True) Then
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(13).Value = (CStr(CustomField1))
			End If
			Me.Adapter.UpdateCommand.Parameters(14).Value = (CInt(Fix(Original_UniqueID)))
			If (Original_Type.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(15).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(16).Value = (CInt(Fix(Original_Type.Value)))
			Else
			...
			If (Original_StartDate.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(18).Value = (CDate(Original_StartDate.Value))
			Else
			...
			If (Original_EndDate.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(20).Value = (CDate(Original_EndDate.Value))
			Else
			...
			If (Original_AllDay.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(22).Value = (CBool(Original_AllDay.Value))
			Else
			...
			If (Original_Status.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(28).Value = (CInt(Fix(Original_Status.Value)))
			Else
			...
			If (Original_Label.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(30).Value = (CInt(Fix(Original_Label.Value)))
			Else
			...
			If (Original_ResourceID.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(32).Value = (CInt(Fix(Original_ResourceID.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(31).Value = (CObj(1))
				Me.Adapter.UpdateCommand.Parameters(32).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(33).Value = (CInt(Fix(UniqueID)))
	...
	Partial Public Class ResourcesTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
			Me._adapter.InsertCommand.Connection = Me.Connection
			Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Resources] ([ResourceID], [ResourceName], [Color], [Image], [CustomField1]) VALUES (@ResourceID, @ResourceName, @Color, @Image, @CustomField1);" & ControlChars.CrLf & "SELECT UniqueID, ResourceID, ResourceName, Color, Image, CustomField1 FROM Resources WHERE (UniqueID = SCOPE_IDENTITY())"
			Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
			Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@ResourceID", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "ResourceID", Global.System.Data.DataRowVersion.Current, False, Nothing, "", "", ""))
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, True)> _
		Public Overridable Function Fill(ByVal dataTable As SchedulerTestDataSet.ResourcesDataTable) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			If (Me.ClearBeforeFill = True) Then
				dataTable.Clear()
			End If
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Select, True)> _
		Public Overridable Function GetData() As SchedulerTestDataSet.ResourcesDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New SchedulerTestDataSet.ResourcesDataTable()
			Me.Adapter.Fill(dataTable)
			Return dataTable
		End Function

		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
		Public Overridable Function Update(ByVal dataTable As SchedulerTestDataSet.ResourcesDataTable) As Integer
			Return Me.Adapter.Update(dataTable)
		End Function
		...
		Public Overridable Function Delete(ByVal Original_UniqueID As Integer, ByVal Original_ResourceID As Integer, ByVal Original_ResourceName As String, ByVal Original_Color? As Integer) As Integer
			Me.Adapter.DeleteCommand.Parameters(0).Value = (CInt(Fix(Original_UniqueID)))
			Me.Adapter.DeleteCommand.Parameters(1).Value = (CInt(Fix(Original_ResourceID)))
			...
			If (Original_Color.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(5).Value = (CInt(Fix(Original_Color.Value)))
			Else
		...
		Public Overridable Function Insert(ByVal ResourceID As Integer, ByVal ResourceName As String, ByVal Color? As Integer, ByVal Image() As Byte, ByVal CustomField1 As String) As Integer
			Me.Adapter.InsertCommand.Parameters(0).Value = (CInt(Fix(ResourceID)))
		...
		Public Overridable Function Update(ByVal ResourceID As Integer, ByVal ResourceName As String, ByVal Color? As Integer, ByVal Image() As Byte, ByVal CustomField1 As String, ByVal Original_UniqueID As Integer, ByVal Original_ResourceID As Integer, ByVal Original_ResourceName As String, ByVal Original_Color? As Integer, ByVal UniqueID As Integer) As Integer
			Me.Adapter.UpdateCommand.Parameters(0).Value = (CInt(Fix(ResourceID)))
			If (ResourceName Is Nothing) Then
				Me.Adapter.UpdateCommand.Parameters(1).Value = Global.System.DBNull.Value
			Else
			...
			End If
			Me.Adapter.UpdateCommand.Parameters(5).Value = (CInt(Fix(Original_UniqueID)))
			Me.Adapter.UpdateCommand.Parameters(6).Value = (CInt(Fix(Original_ResourceID)))
			If (Original_ResourceName Is Nothing) Then
			...
			If (Original_Color.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(10).Value = (CInt(Fix(Original_Color.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CObj(1))
				Me.Adapter.UpdateCommand.Parameters(10).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(11).Value = (CInt(Fix(UniqueID)))
			Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.UpdateCommand.Connection.State
			If ((Me.Adapter.UpdateCommand.Connection.State And Global.System.Data.ConnectionState.Open) <> Global.System.Data.ConnectionState.Open) Then
				Me.Adapter.UpdateCommand.Connection.Open()
			End If
