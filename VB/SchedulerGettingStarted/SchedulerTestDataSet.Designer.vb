...
Namespace SchedulerGettingStarted
    ...
    Partial Public Class SchedulerTestDataSet
        ...
        Public Overrides Function Clone() As Global.System.Data.DataSet
            Dim cln As SchedulerTestDataSet = (DirectCast(MyBase.Clone(), SchedulerTestDataSet))
            cln.InitVars()
        ...
        Partial Public Class AppointmentsDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddAppointmentsRow(ByVal Type As Integer, ByVal StartDate As Date, ByVal EndDate As Date, ByVal AllDay As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status As Integer, ByVal Label As Integer, ByVal ResourceID As Integer, ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal TimeZoneId As String, ByVal CustomField1 As String) As AppointmentsRow
                Dim rowAppointmentsRow As AppointmentsRow = (DirectCast(Me.NewRow(), AppointmentsRow))
                Dim columnValuesArray() As Object = { Nothing, Type, StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, TimeZoneId, CustomField1}
        ...
        Partial Public Class AppointmentsRow
            ...
            Public Property CustomField1() As String
                Get
                    Try
                        Return (DirectCast(Me(Me.tableAppointments.CustomField1Column), String))
                    Catch e As Global.System.InvalidCastException
    ...
    End Class
End Namespace
Namespace SchedulerGettingStarted.SchedulerTestDataSetTableAdapters
...
"SELECT UniqueID, Type, StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, TimeZoneId, CustomField1 FROM Appointments WHERE (UniqueID = @UniqueID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = My.Settings.Default.SchedulerTestConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT UniqueID, Type, StartDate, EndDate, AllDay, Subject, Location, Description" & ", Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, TimeZone" & "Id, CustomField1 FROM dbo.Appointments"
        ...
        Public Overridable Function Insert(ByVal Type? As Integer, ByVal StartDate? As Global.System.DateTime, ByVal EndDate? As Global.System.DateTime, ByVal AllDay? As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status? As Integer, ByVal Label? As Integer, ByVal ResourceID? As Integer, ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal TimeZoneId As String, ByVal CustomField1 As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(13).Value = (CStr(TimeZoneId))
            End If
        ...
        Public Overridable Function Update(ByVal Type? As Integer, ByVal StartDate? As Global.System.DateTime, ByVal EndDate? As Global.System.DateTime, ByVal AllDay? As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status? As Integer, ByVal Label? As Integer, ByVal ResourceID? As Integer, ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal TimeZoneId As String, ByVal CustomField1 As String, ByVal Original_UniqueID As Integer, ByVal Original_Type? As Integer, ByVal Original_StartDate? As Global.System.DateTime, ByVal Original_EndDate? As Global.System.DateTime, ByVal Original_AllDay? As Boolean, ByVal Original_Subject As String, ByVal Original_Location As String, ByVal Original_Status? As Integer, ByVal Original_Label? As Integer, ByVal Original_ResourceID? As Integer, ByVal UniqueID As Integer) As Integer
            If (Type.HasValue = True) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(13).Value = (CStr(TimeZoneId))
            End If
            If (CustomField1 Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(15).Value = (CInt(Original_UniqueID))
            If (Original_Type.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(16).Value = (DirectCast(0, Object))
                Me.Adapter.UpdateCommand.Parameters(17).Value = (CInt(Original_Type.Value))
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(25).Value = (CStr(Original_Subject))
            End If
            If (Original_Location Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(27).Value = (CStr(Original_Location))
            End If
            If (Original_Status.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(28).Value = (DirectCast(0, Object))
                Me.Adapter.UpdateCommand.Parameters(29).Value = (CInt(Original_Status.Value))
            Else
            ...
            If (Original_Label.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(31).Value = (CInt(Original_Label.Value))
            Else
            ...
            If (Original_ResourceID.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(33).Value = (CInt(Original_ResourceID.Value))
            Else
                Me.Adapter.UpdateCommand.Parameters(32).Value = (DirectCast(1, Object))
                Me.Adapter.UpdateCommand.Parameters(33).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(34).Value = (CInt(UniqueID))
